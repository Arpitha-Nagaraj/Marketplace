...
<?php
$sql = "SELECT * FROM products where name = 'Dog Food'";
...
if (isset($_COOKIE["recentProducts"])) {
    if (explode(",", $_COOKIE["recentProducts"])[0] != null) {
        setcookie("recentProducts", "Dog Food" . "," . $_COOKIE["recentProducts"], time() + (86400 * 30));
    }
} else {
    setcookie("recentProducts", "Dog Food", time() + (86400 * 30));
}
?>
                ...
                <div>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           <h4>Dog Food</h4>
                           <img src= './Product2_Food.jpg'>
                        </div>
                        <div class="panel-body">
                            <p>This food is so good, your dog will forget they're chasing squirrels... for a whole five minutes.
                                 Looks Yum, tastes Yum!
                            </p>
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                <?php
                                    $sql = "SELECT * FROM productRating WHERE product_id = 3";
                                    $result = $link->query($sql);
                                    $myInteger = 0;
