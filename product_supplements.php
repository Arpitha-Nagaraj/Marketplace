...
<?php
$sql = "SELECT * FROM products where name = 'Supplements'";
...
if (isset($_COOKIE["recentProducts"])) {
    if (explode(",", $_COOKIE["recentProducts"])[0] != null) {
        setcookie("recentProducts", "Supplements" . "," . $_COOKIE["recentProducts"], time() + (86400 * 30));
    }
} else {
    setcookie("recentProducts", "Supplements", time() + (86400 * 30));
}
?>
                ...
                <div>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           <h4>Supplements</h4>
                           <img src= './Product7_Dogsupplements.jpg'>
                        </div>
                        <div class="panel-body">
                            <p>it's a magic potion for a healthier, happier pup
                            </p>
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                <?php
                                    $sql = "SELECT * FROM productRating WHERE product_id = 11";
                                    $result = $link->query($sql);
                                    $myInteger = 0;
