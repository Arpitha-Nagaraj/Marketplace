...
<?php
$sql = "SELECT * FROM products where name = 'Toys'";
...
if (isset($_COOKIE["recentProducts"])) {
    if (explode(",", $_COOKIE["recentProducts"])[0] != null) {
        setcookie("recentProducts", "Toys" . "," . $_COOKIE["recentProducts"], time() + (86400 * 30));
    }
} else {
    setcookie("recentProducts", "Toys", time() + (86400 * 30));
}
?>
                ...
                <div>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           <h4>Toys</h4>
                           <img src= './Product8_Dogtoys.jpg'>
                        </div>
                        <div class="panel-body">
                            <p>Toys with ridges or textures specifically designed to massage gums and clean teeth.
                            </p>
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                <?php
                                    $sql = "SELECT * FROM productRating WHERE product_id = 9";
                                    $result = $link->query($sql);
                                    $myInteger = 0;
