...
<?php
$sql = "SELECT * FROM products where name = 'comb'";
...
if (isset($_COOKIE["recentProducts"])) {
    if (explode(",", $_COOKIE["recentProducts"])[0] != null) {
        setcookie("recentProducts", "Comb" . "," . $_COOKIE["recentProducts"], time() + (86400 * 30));
    }
} else {
    setcookie("recentProducts", "Comb", time() + (86400 * 30));
}
?>
                ...
                <div>
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <p>A dog comb is a grooming tool used to remove loose hair, dirt, and tangles from a dog's fur. 
                                It can also be used to distribute natural oils and stimulate the skin. 
                                "Finally, a weapon against the never-ending battle of dog hair!"
                            </p>
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                <?php
                                    $sql = "SELECT * FROM productRating WHERE product_id = 1";
                                    $result = $link->query($sql);
                                    $myInteger = 0;
