...
<?php
$sql = "SELECT * FROM products where name = 'Name tag'";
...
if (isset($_COOKIE["recentProducts"])) {
    if (explode(",", $_COOKIE["recentProducts"])[0] != null) {
        setcookie("recentProducts", "Name tag" . "," . $_COOKIE["recentProducts"], time() + (86400 * 30));
    }
} else {
    setcookie("recentProducts", "Name tag", time() + (86400 * 30));
}
?>
                ...
                <div>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           <h4>Name tag</h4>
                           <img src= './Product5_Tag.jpg'>
                        </div>
                        <div class="panel-body">
                            <p>Lost dog? No way! This snazzy tag will have your pup back in your arms in no time.
                            </p>
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                <?php
                                    $sql = "SELECT * FROM productRating WHERE product_id = 10";
                                    $result = $link->query($sql);
                                    $myInteger = 0;
