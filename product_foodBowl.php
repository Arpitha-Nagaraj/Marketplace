...
<?php
$sql = "SELECT * FROM products where name = 'Food bowl'";
...
if (isset($_COOKIE["recentProducts"])) {
    if (explode(",", $_COOKIE["recentProducts"])[0] != null) {
        setcookie("recentProducts", "Food bowl" . "," . $_COOKIE["recentProducts"], time() + (86400 * 30));
    }
} else {
    setcookie("recentProducts", "Food bowl", time() + (86400 * 30));
}
?>
                ...
                <div>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           <h4>Food bowl</h4>
                           <img src= './Product4_Bowl.jpg'>
                        </div>
                        <div class="panel-body">
                            <p>Upgrade your dog's dinnerware from "sad plastic bowl" to "sophisticated dining vessel.
                            </p>
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                <?php
                                    $sql = "SELECT * FROM productRating WHERE product_id = 8";
                                    $result = $link->query($sql);
                                    $myInteger = 0;
