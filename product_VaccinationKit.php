...
<?php
$sql = "SELECT * FROM products where name = 'Vaccination kit'";
...
if (isset($_COOKIE["recentProducts"])) {
    if (explode(",", $_COOKIE["recentProducts"])[0] != null) {
        setcookie("recentProducts", "Vaccination kit" . "," . $_COOKIE["recentProducts"], time() + (86400 * 30));
    }
} else {
    setcookie("recentProducts", "Vaccination kit", time() + (86400 * 30));
}
?>
                ...
                <div>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           <h4>Vaccination kit</h4>
                           <img src= './Product9_dogvaccine.jpg'>
                        </div>
                        <div class="panel-body">
                            <p>The pawsome way to protect your dog from serious diseases.
                            </p>
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                <?php
                                    $sql = "SELECT * FROM productRating WHERE product_id = 7";
                                    $result = $link->query($sql);
                                    $myInteger = 0;
