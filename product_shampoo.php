...
if (isset($_COOKIE["recentProducts"])) {
    if (explode(",", $_COOKIE["recentProducts"])[0] != null) {
        setcookie("recentProducts", "Dog shampoo" . "," . $_COOKIE["recentProducts"], time() + (86400 * 30));
    }
} else {
    setcookie("recentProducts", "Dog shampoo", time() + (86400 * 30));
}
?>
                ...
                <div>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           <h4>Dog shampoo</h4>
                           <img src= './Product6_Dogshampoo.jpg'>
                        </div>
                        <div class="panel-body">
                            <p>Transform your fur-ocious beast into a fragrant friend with this magical shampoo.
                            </p>
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                <?php
                                    $sql = "SELECT * FROM productRating WHERE product_id = 4";
                                    $result = $link->query($sql);
                                    $myInteger = 0;
